# Eliza Cloudbet NBA Betting Plugin and Tutorial

This is the codebase and tutorial for building a Cloudbet NBA Betting Eliza plugin.

Plugin code is located at `plugins/Cloudbet NBA Betting-plugin`.
