...
aiverseLogger.info("Loading embedding settings:", {
...
aiverseLogger.info("Loading character settings:", {
...
export function loadEnvConfig(): Settings {
    ...
    if (!result.error) {
        aiverseLogger.log(`Loaded .env file from: ${envPath}`);
    }
...
aiverseLogger.info("Parsed settings:", {
